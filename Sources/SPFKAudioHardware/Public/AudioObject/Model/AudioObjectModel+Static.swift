...
extension AudioObjectModel {
    private static func getPropertyDataArraySize<Q>(_ objectID: AudioObjectID,
    ...
    private static func getPropertyDataSize<Q>(_ objectID: AudioObjectID,
                                               address: AudioObjectPropertyAddress,
                                               qualifierDataSize: UInt32?,
                                               qualifierData: inout Q,
                                               andSize size: inout UInt32) -> (OSStatus) {
    ...
    private static func getPropertyDataArray<T, Q>(_ objectID: AudioObjectID,
                                                   address: AudioObjectPropertyAddress,
                                                   qualifierDataSize: UInt32?,
                                                   qualifierData: inout Q,
                                                   value: inout [T],
...
extension AudioObjectModel {
    static func setPropertyData<T>(_ objectID: AudioObjectID,
        ...
        return AudioObjectSetPropertyData(objectID,
                                          &theAddress,
                                          UInt32(0),
                                          nil,
                                          size,
